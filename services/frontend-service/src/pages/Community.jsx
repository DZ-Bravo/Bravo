      ...
      <main className="community-main">
        <div className="community-container">
            ...
            <>
              ...
              <div className="latest-section">
                ...
                {isLoadingLatest ? (
                  ...
                  <div style={{ display: 'flex', flexWrap: 'nowrap', gap: '20px', justifyContent: 'center', width: '100%', overflowX: 'auto' }}>
          ...
          {selectedCategory !== 'all' && (
            <>
              {(selectedCategory === 'diary' || showBookmarks) ? (
