// bottom 컬렉션에서 title에 '긴팔티', '맨투맨', '후드티', '아르테', '벤투스', '터틀넥'이 포함된 문서들을 top 컬렉션으로 이동
...
print("\n1. bottom 컬렉션에서 '긴팔티', '맨투맨', '후드티', '아르테', '벤투스', '터틀넥'이 포함된 문서 검색 중...");
print("   (단, brand가 '디스커버리 익스페디션'인 것은 제외)");

const keywords = ["긴팔티", "맨투맨", "후드티", "아르테", "벤투스", "터틀넥"];
